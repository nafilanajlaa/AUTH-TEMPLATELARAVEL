...
<!-- Sidebar - Brand -->
    <a href="index.html" class="sidebar-brand d-flex align-items-center justify-content-center">
        <div class="sidebar-brand-icon">
            <img style="width: 100%;" src="{{ asset('sbadmin2/img/laracamp/icon.png') }}" alt="Laracamp">
        </div>
        <div class="sidebar-brand-text mx-3">
            <img style="width: 100%;" src="{{ asset('sbadmin2/img/laracamp/laracamp (1).png') }}" alt="Laracamp">
        </div>
    </a>
<!-- Divider -->
